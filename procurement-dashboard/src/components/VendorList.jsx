...
// ── 스타일 ───────────────────────────────────────────────────────────────────
const S = {
  card:          { background: '#fff', borderRadius: 12, padding: '18px 22px', boxShadow: '0 1px 4px rgba(0,0,0,0.07)', marginBottom: 16 },
  ...
  searchBtn:     { padding: '9px 22px', background: '#1677ff', color: '#fff', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer' },
  filterRow:     { display: 'flex', flexWrap: 'wrap', gap: 6 },
  filterBtn:     { padding: '5px 14px', border: '1px solid #e2e8f0', borderRadius: 99, fontSize: 13, background: '#fff', color: '#64748b', cursor: 'pointer' },
  filterBtnActive:{ background: '#1677ff', color: '#fff', borderColor: '#1677ff', fontWeight: 600 },
  tableHeader:   { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 },
  tableTitle:    { fontSize: 15, fontWeight: 700, color: '#1e293b', display: 'flex', alignItems: 'center', gap: 8 },
  totalBadge:    { fontSize: 13, fontWeight: 500, color: '#64748b', background: '#f1f5f9', padding: '2px 10px', borderRadius: 99 },
  table:         { width: '100%', borderCollapse: 'collapse', fontSize: 13 },
  th:            { padding: '10px 12px', fontWeight: 600, color: '#64748b', borderBottom: '2px solid #f0f0f0', textAlign: 'left', whiteSpace: 'nowrap', background: '#fafafa' },
  td:            { padding: '10px 12px', borderBottom: '1px solid #f5f5f5', color: '#1e293b', whiteSpace: 'nowrap' },
  pagination:    { display: 'flex', justifyContent: 'center', gap: 6, marginTop: 18 },
  pageBtn:       { padding: '6px 14px', border: '1px solid #e2e8f0', borderRadius: 8, fontSize: 13, background: '#fff', cursor: 'pointer', color: '#334155' },
  pageBtnActive: { background: '#1677ff', color: '#fff', borderColor: '#1677ff', fontWeight: 700 },
  pageBtnDisabled:{ color: '#bfbfbf', cursor: 'not-allowed' },
};
...
const M = {
  ...
  panel:       { background: '#fff', borderRadius: 16, width: 560, maxWidth: '92vw', maxHeight: '80vh', display: 'flex', flexDirection: 'column', boxShadow: '0 8px 32px rgba(0,0,0,0.18)' },
  ...
  biz:         { fontSize: 13, color: '#94a3b8', marginTop: 4 },
  item:        { color: '#64748b' },
  closeBtn:    { background: 'none', border: 'none', fontSize: 18, color: '#94a3b8', cursor: 'pointer' },
  body:        { padding: '20px 24px', overflowY: 'auto' },
  sectionTitle:{ fontSize: 14, fontWeight: 600, color: '#64748b', marginBottom: 14 },
  certGrid:    { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 8, marginBottom: 20 },
  certItem:    { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, padding: '12px 8px', borderRadius: 10, textAlign: 'center' },
  footer:      { fontSize: 13, color: '#94a3b8', textAlign: 'right' },
};
