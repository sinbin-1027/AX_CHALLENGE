...
// ── 스타일 ───────────────────────────────────────────────────────────────────
const S = {
  card:          { background: '#fff', borderRadius: 12, padding: '20px 24px', boxShadow: '0 1px 4px rgba(0,0,0,0.07)', marginBottom: 4 },
  cardTitle:     { fontSize: 15, fontWeight: 700, color: '#1e293b', marginBottom: 14 },
  uploadHint:    { fontSize: 13, color: '#8c8c8c', marginBottom: 14, background: '#fafafa', padding: '8px 12px', borderRadius: 8 },
  uploadRow:     { display: 'flex', alignItems: 'flex-end', gap: 16, flexWrap: 'wrap' },
  field:         { display: 'flex', flexDirection: 'column', gap: 4 },
  label:         { fontSize: 12, fontWeight: 500, color: '#64748b' },
  select:        { padding: '8px 12px', border: '1px solid #e2e8f0', borderRadius: 8, fontSize: 14, outline: 'none', background: '#fff', minWidth: 140 },
  uploadBtn:     { padding: '8px 20px', background: '#1677ff', color: '#fff', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer' },
  uploadSuccess: { display: 'flex', alignItems: 'center', gap: 8, fontSize: 14, color: '#52c41a', fontWeight: 500, padding: '8px 12px', background: '#f6ffed', border: '1px solid #b7eb8f', borderRadius: 8 },
  uploadSub:     { fontSize: 12, color: '#8c8c8c', fontWeight: 400 },
  error:         { marginTop: 10, padding: '10px 14px', background: '#fef2f2', color: '#ef4444', borderRadius: 8, fontSize: 13 },
  insufficientWrap: { display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 16, flexWrap: 'wrap' },
  insufficientLabel:{ fontSize: 13, fontWeight: 600, color: '#64748b', whiteSpace: 'nowrap', paddingTop: 3 },
  badgeRow:      { display: 'flex', flexWrap: 'wrap', gap: 6 },
  insufficientBadge:{ fontSize: 12, padding: '2px 10px', borderRadius: 99, background: '#fff7e6', color: '#d46b08', border: '1px solid #ffd591', fontWeight: 500 },
  recommendBtn:  { padding: '10px 28px', background: '#1677ff', color: '#fff', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer', marginBottom: 20 },
  ...
  vendorCard:    { border: '1px solid #e2e8f0', borderRadius: 10, padding: '16px 18px', background: '#fafafa', display: 'flex', flexDirection: 'column', gap: 10 },
  ...
  vendorBiz:     { fontSize: 12, color: '#94a3b8', marginTop: 2 },
  resolveChip:   { fontSize: 12, fontWeight: 700, padding: '4px 12px', borderRadius: 99, background: '#e6f4ff', color: '#0958d9', border: '1px solid #91caff', whiteSpace: 'nowrap' },
  vendorItem:    { fontSize: 13, color: '#64748b' },
  vendorFooter:  { fontSize: 12, color: '#94a3b8', marginTop: 2 },
  vendorDate:    { color: '#bfbfbf' },
};
